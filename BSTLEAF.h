...
class BSTLEAF: public Map<K,V, comp_func, equals_func>
{
	public:
		...
		//BIG 5
		BSTLEAF(const BSTLEAF& old) //copy constructor
		{
			root = new Node<K, V>(old.root);
		}
		~BSTLEAF()	{	delete root;	}//will recursively get rid of all of the Nodes.
		BSTLEAF operator=(BSTLEAF& old)
		{
			this->root = new Node<K, V>(old.root); 		//creates a new Node will recursively make new Nodes until nullptr.
			return this;
		}
		BSTLEAF(BSTLEAF&& other)		//move constructor, doesnt return anything.
		{
			root = other.root;
			other.root = nullptr;
		}
		BSTLEAF& operator=(BSTLEAF&& other)		//move assignment operator
		{
			root = other.root;
			other.root = nullptr;
			return *this;
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
BSTLEAF<K, V, comp_func, equals_func>::BSTLEAF()
{
	root = nullptr;
}

template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
void BSTLEAF<K, V, comp_func, equals_func>::insert(K key, V val)
{
	if(!root)
		{
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
void BSTLEAF<K, V, comp_func, equals_func>::insert(K mkey, V val, Node<K, V>*& here)
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
void BSTLEAF<K, V, comp_func, equals_func>::remove(K key)
{
	this->remove(key, root);
}

template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
void BSTLEAF<K, V, comp_func, equals_func>::remove(K key, Node<K, V>*& here)
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
V& BSTLEAF<K, V, comp_func, equals_func>::lookup(K key)
{
	try
	{
		if(this->root)
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
V& BSTLEAF<K, V, comp_func, equals_func>::lookup(K key, Node<K, V>* here)
{
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
bool BSTLEAF<K, V, comp_func, equals_func>::contains(K key)
{
	Node<K,V>* temp = root;
		while(temp)
		{
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
bool BSTLEAF<K, V, comp_func, equals_func>::is_empty()
{
	if(!root)
		return false;
	return true;
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
bool BSTLEAF<K, V, comp_func, equals_func>::is_full()
{
	return false;
}

template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
int BSTLEAF<K, V, comp_func, equals_func>::size()
{
	return size(root);
}

template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
int BSTLEAF<K, V, comp_func, equals_func>::size(Node<K,V>* here)
{
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
void BSTLEAF<K, V, comp_func, equals_func>::clear()
{
	delete root;
}

template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
int BSTLEAF<K, V, comp_func, equals_func>::height()
{
	return height(root);
}

template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
int BSTLEAF<K, V, comp_func, equals_func>::height(Node<K, V>* here)
{
	if(!here)
		return 0;
...
template <typename K, typename V, bool (*comp_func)(const K& y, const K& z), bool (*equals_func)(const K& y, const K& z)>
int BSTLEAF<K, V, comp_func, equals_func>::balance()
{
